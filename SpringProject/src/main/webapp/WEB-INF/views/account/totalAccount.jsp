...
<body>
				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">${memberName }님의 실시간 종합계좌(잔고비율)</h4>
									<div>
										<canvas id="donutChart" width="400" height="400"></canvas>
									</div>
									<div class="text-md-center text-xl-left">
										<br> <label for="myAccount"
											class="col-sm-3 col-form-label">주문 가능 현금</label> <input
											class="form-control text-center" type="text" name="myAccount"
											...
											<div class="text-center">
												<table id="example" class="table table-hover">
													<tr>
														<th>총 평가금액</th>
														<td id="totalBalance">
															<!-- Remove the extra quotes here --> <!-- 데이터가 나와야할 공간 -->
														</td>
													</tr>
												</table>
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<h3 class="card-title">${memberName }님의거래내역</h3>
									<table id="example" class="table table-hover">
										<tr>
											<th>종목</th>
											<th>가격</th>
	...
	<!-- 제이쿼리와 jQuery UI 로드 후 다른 스크립트 로드 -->
	...
	<script>
		...
		/*
		var orderedQuantity = parseInt("${orderedQuantity}");
		var orderedPrice = parseInt("${orderedPrice}");
		var orderedAction = "${orderedAction}";
		var currentPrice = parseInt("${currentPrice}");
		 */
	</script>
	<script src="/balance/js/history.js"></script>
	<script src="/balance/js/getUserHoldings.js"></script>
	<script src="/balance/js/chart.js"></script>
