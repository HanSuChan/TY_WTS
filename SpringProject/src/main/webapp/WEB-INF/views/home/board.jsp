...
<body>
	<div class="container-scroller">
		...
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
			...
			<ul class="nav">
				...
				<li class="nav-item menu-items"><a class="nav-link"
					href="/LetterBox"> <span class="menu-icon"> <i
							class="mdi mdi-speedometer"></i>
					</span> <span class="menu-title">쪽지함</span>
				</a></li>
					...
					<ul class="navbar-nav navbar-nav-right">
						...
						<li class="nav-item dropdown border-left"><a
							...
							<div
								...
								aria-labelledby="messageDropdown" id="dropdown-item">
								<div id="messageWrite"><h6 class="p-3 mb-0">Messages</h6></div>
								...
								<div class="card-body">
									<table id="example" class="table table-hover">
										<thead>
											<tr>
												<th>Q&A 게시판</th>
												<th><button type="button" class="btn btn-outline-secondary" id="writeBtn">글쓰기</button></th>
											</tr>
										</thead>
										<tbody id="listArea">
										</tbody>
	...
	<div id="myModal" class="modal">
        <div class="modal-content">
             ...
             <input type="number" id="ltime" name="ltime" hidden="hidden">
    		 <input type="text" id="lto_id" name="lto_id" required hidden="hidden">
            <table>
            <tr><td>            	
               <label for="lfrom_id">from :</label></td><td>
                 <input type="text" id="lfrom_id" name="lfrom_id" required readonly="readonly">
                </td></tr>
               <tr><td>
                <label for="ltitle">title :</label></td><td>
                <input type="text" id="ltitle" name="ltitle" required readonly="readonly"></td></tr>
               <tr><td>
                <label for="lcontent">content :</label></td><td>
                <textarea id="lcontent" name="lcontent" required readonly="readonly"></textarea>
                </td></tr>
                <tr><td>
                <tr><td>
                <input type="submit" value="삭제" ></td><td>
                <input type="button" value="닫기" onclick="closeModal(0)"></td></tr>            
            </table>
            </form>
        </div>
    </div>
    ...
    <div id="yourModal" class="modal">
        <div class="modal-content">
             <form action="process" method="post" id="yourForm">
             <input type="text" id="from_idl" name="from_idl" required hidden="hidden">
            <table>            	
               <tr><td>
                <label for="to_idl">to :</label></td><td>
                <input type="text" id="to_idl" name="to_idl" required></td></tr>
               <tr><td>
                <label for="titlel">title :</label></td><td>
                <input type="text" id="titlel" name="titlel" required></td></tr>
               <tr><td>
                <label for="contentl">content :</label></td><td>
                <textarea id="contentl" name="contentl" required></textarea></td></tr>
                <tr><td>
                <input type="submit" value="보내기" ></td><td>
                <input type="button" value="닫기" onclick="closeModal(1)"></td></tr>            
            </table>
            </form>
        </div>
    </div>
		...
		<script src="/letter/js/letter.js"></script>
