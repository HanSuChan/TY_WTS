				...
				<div
					...
					<div class="card col-lg-4 mx-auto">
						<div class="card-body px-5 py-5">
							<h3 class="card-title text-left mb-3">회원 정보 수정</h3>
							<form action="/member/updateresult" method="post">
								...
								<div class="form-group">
									<label>변경 비밀번호</label> <input type="password" name="userpw1"
										id="pw" class="form-control p_input" onchange="check_pw()"
										required
										placeholder="비밀번호는 특수문자를 포함한 6글자 이상, 16글자 이하만 이용 가능합니다.">
								</div>
								<div class="form-group">
									<label>변경 비밀번호 확인</label> <input type="password" name="userpw2"
								...
								<div class="text-center">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<button type="reset" class="btn btn-danger" id="cancelButton">로그인
										화면으로 되돌아가기</button>
								</div>
							</form>
						</div>
