						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									...
									<div style="position: fixed; right: 100px; bottom: 360px;">
										<form action="/updateBoard/page" method="get">
											<input type="hidden" name="updateBoardIdx"
												value="<%=request.getParameter("idx")%>">

											<button type="submit" class="btn btn-success">수정</button>
										</form>
									</div>
									<div style="position: fixed; right: 170px; bottom: 360px;">
										<form action="deleteBoard" method="get">
											<input type="hidden" name="deleteBoardIdx"
												value="<%=request.getParameter("idx")%>">
